    ...
    ui(new Ui::MainWindow)
{
    ...
    QStringList cat;cat<<"kº" << "Bissessao"<<"Posicão Falsa"<<"Newton-Rapson";

    ui->daniel->setColumnCount(4);

    ui->daniel->setHorizontalHeaderLabels(titulos);

    ui->daniel->setRowCount(4);

    ui->daniel->setVerticalHeaderItem(0,new QTableWidgetItem("daniel"));
    ui->daniel->setVerticalHeaderItem(1,new QTableWidgetItem("daniel"));
    ui->daniel->setVerticalHeaderItem(2,new QTableWidgetItem("daniel"));
